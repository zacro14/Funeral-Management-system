...
<!-- Modal -->
<div class="modal fade" id="cancelreservation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="reservation-cancel-query.php" method="POST">
        ...
        <div class="modal-footer">  
            ...
            <button type="submit" class="btn btn-danger text-capitalize" name="cancel-reservation">cancel reservation</button>
      </div>
      </form>

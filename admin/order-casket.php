...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Order Caskets</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form name="order_casket" id="order_casker" action="order-casket-action.php" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <select name="casket[]" id="" class="form-control" required>
                                                                    <option value="" disabled selected>-Select Casket-</option>
                                                                    <?php
                                                            ...
                                                            <td><input type="number" name="quantity[]" class="form-control" placeholder="Enter here..."/></td>
